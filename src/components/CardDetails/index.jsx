...
const CardDetails = ({ content, size, image, redirectTo, functionality, navigation, handleSetSelectedVillage, villageListing, search }) => {
    ...
    if (!content) {
        return <NoDataFound message={"There are no villages"} />;
    }
